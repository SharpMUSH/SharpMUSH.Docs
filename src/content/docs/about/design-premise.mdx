...
You can read about our compatibility in more details on our [Compatibility](reference/compatibility) page. SharpMUSH aims for 'best effort' compatibility; This means that while we expect most tools to be compatible, we are not afraid to break some more idiosynchratic elements. 
