...
See also: [event examples2](#event examples2)
...
The following event types and events have been added to SharpMUSH. To see the help for them, type [event type](#event type).
