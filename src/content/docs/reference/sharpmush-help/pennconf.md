...
- `use_muxcomm=<boolean>`: Enable MUX-style channel aliases? See [muxcomsys](/reference/sharpmush-help/pennchat/#muxcomsys)
...
- `monikers=<list>`: Where should @monikers be displayed? See [monikers](/reference/sharpmush-help/penntop/#monikers)
...
See [@config cosmetic2](/reference/sharpmush-help/pennconf/#config-cosmetic2)
...
See [@config limits2](/reference/sharpmush-help/pennconf/#config-limits2)
...
See [@config limits3](/reference/sharpmush-help/pennconf/#config-limits3)
...
See [@config limits4](/reference/sharpmush-help/pennconf/#config-limits4)
